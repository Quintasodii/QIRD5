...
const AddClases = () => {
    ...
    const handleSubirClase = (description, selectedGender, selectedDateTime ) => {
        ...
        setmodalvisible(false)
            ...
            console.log(error, 'ESO PASO YO LO V')
        }
    }
   useEffect(() => {
  ...
  return (
    <View style={styles.ContenedorPrimal}>
        <View style={styles.header}><Text style={styles.textotitulo}>Agregar Clase</Text><IconButton name={agregar} style={styles.AllClases} onPress={() => setmodalvisible(true)}/></View>
        ...
        <ScrollView style={{marginTop: 30}}>
            ...
            <Modal transparent={true} animationType='fade' visible={modalvisible} onRequestClose={()=> setmodalvisible(false)}>
                <View style={styles.modalBackground}>
                    ...
                    <View style={styles.Cerrar}><Text style={{color: '#009BDE', textAlign: 'left', textAlignVertical: 'center', fontSize: 30, marginRight: 97}}>Agregar Clase</Text><IconButton name={Close} onPress={()=> setmodalvisible(false)}/></View>
                    <View style={styles.FormModal}>
                    <Text style={{textAlign: 'left', color: '#fff', fontSize: 20, alignSelf: 'flex-start', marginBottom: 25, marginTop: 30}}>Fecha y Hora : </Text>
                    <TouchableOpacity onPress={openModal}><Text style={styles.fonttextji}>{selectedDateTime}</Text></TouchableOpacity>
                    <Text style={{textAlign: 'left', color: '#fff', fontSize: 20, alignSelf: 'flex-start', marginBottom: 25, marginTop: 30}}>Genero : </Text>
                    ...
                    <Text style={{textAlign: 'left', color: '#fff', fontSize: 20, alignSelf: 'flex-start', marginBottom: 25, marginTop: 30}}>Descripcion : </Text>
